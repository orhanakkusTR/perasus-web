        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-6 text-base">
              Licensed General Contractor with 20+ years of international construction experience. Serving NJ, NY, and PA with quality commercial and residential projects.
            </p>
