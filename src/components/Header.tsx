      ...
      <nav className="container mx-auto px-4 sm:px-6 flex items-center justify-between">
        <Link to="/" className="flex items-center">
          <img
            ...
            width="220"
            height="94"
            className="h-11 sm:h-14 md:h-16 w-auto transition-all duration-500"
          />
        </Link>
        ...
        <div className="hidden lg:flex items-center space-x-8">
          ...
          <button
            onClick={() => handleNavigation('/real-estate-investment')}
            className={`font-medium transition-all duration-300 hover:text-primary relative group text-gray-700 ${location.pathname === '/real-estate-investment' ? 'text-primary' : ''}`}
          >
            Real Estate
            <span className={`absolute -bottom-1 left-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full ${
              location.pathname === '/real-estate-investment' ? 'w-full' : ''
            }`}></span>
          </button>
        ...
        <div className="lg:hidden bg-white shadow-xl animate-fade-in">
          <div className="container mx-auto px-6 py-6 space-y-4">
            ...
            <button
              onClick={() => handleNavigation('/real-estate-investment')}
              className={`block w-full text-left text-gray-700 font-medium hover:text-primary transition-colors ${
                location.pathname === '/real-estate-investment' ? 'text-primary' : ''
              }`}
            >
              Real Estate
            </button>
