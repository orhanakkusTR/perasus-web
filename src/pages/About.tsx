...
export default function About() {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="About Perasus Construction - Nearly 20 Years of Excellence in NJ, NY & PA"
        ...
        <div className="relative z-20 container mx-auto px-6 text-white">
          <div className="max-w-4xl">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mb-8 leading-relaxed animate-slide-up-delay">
              With nearly two decades of international expertise, we bring world-class engineering, construction, and project management to New Jersey, New York, and Pennsylvania.
            </p>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-8">
                With nearly two decades of engineering, construction, and project management experience, Perasus Construction brings together a team of internationally trained professionals who have successfully delivered projects across <span className="font-semibold text-gray-900">Asia, Europe, Africa, and the Americas</span>.
              </p>
              ...
              <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-8">
                As a licensed General Contractor, we offer a full range of capabilities under one roof — including engineering, architecture, interior design, on-site execution, and complete project coordination. By collaborating with a trusted network of specialized subcontractors, we ensure every project is completed with exceptional craftsmanship and precision.
              </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 md:p-10 border border-white/20 mb-8">
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-white mb-2">Solar & Insulation</h4>
                    <p className="text-white/90 text-sm">Solar panels, upgraded insulation & LED lighting</p>
                  </div>
                </div>
              </div>
            </div>
