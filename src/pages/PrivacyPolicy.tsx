          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                Perasus Construction ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
              </p>
            </div>
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <div>
                  ...
                  <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
                    ...
                    <li>Communication history with our company</li>
                  </ul>
                </div>
            ...
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Information Sharing and Disclosure</h2>
              <p className="text-gray-700 leading-relaxed mb-3">We do not sell your personal information. We may share your information with:</p>
              <ul className="list-disc list-inside ml-4 space-y-2 text-gray-700">
                ...
                <li><strong>Business Partners:</strong> Suppliers and contractors involved in your project (with your consent)</li>
            ...
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Cookies and Tracking Technologies</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Data Security</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">California Privacy Rights</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg space-y-2">
                ...
                <p className="text-gray-700">New Jersey, New York & Pennsylvania</p>
