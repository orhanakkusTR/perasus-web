...
export default function Gallery() {
  ...
  const portfolioData = {
    ...
    description: 'View our completed projects including kitchen renovations, bathroom remodels, flooring installations, and commercial construction in NJ, NY, and PA.',
  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        description="Browse our portfolio of completed construction projects in NJ, NY & PA. Kitchen renovations, bathroom remodels, flooring, and commercial construction. 20+ years experience."
                ...
                <div className="relative h-64 sm:h-72 md:h-80 overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 md:p-6 text-white">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-xs text-primary-light">{project.year}</span>
                    </div>
              ...
              {[
                {
                  ...
                  description: 'Successfully delivered transformations across NJ, NY, PA'
                },
                {
                  icon: HomeIcon,
                  number: '100%',
