    ...
    try {
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          ...
          subject: 'New Contact Message — Perasus Construction',
          from_name: 'Perasus Construction Website',
          name: formData.name,
  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        canonicalUrl="https://www.perasusconstruction.com/contact"
                    ...
                    <div className="bg-gray-50 p-6 rounded-xl hover:shadow-lg transition-all duration-300">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <a href="https://wa.me/18624029355" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-green-600 transition-colors">
                            +1 (862) 402-9355
                          </a>
