...
export default function Home() {
  ...
  const organizationData = {
    ...
    description: 'Licensed General Contractor - Construction, Renovation & Project Management in NJ, NY, PA',
  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        description="Licensed General Contractor with 20+ years experience. Commercial & Residential construction, renovation, and project management serving NJ, NY, PA. Call (862) 402-9355."
          ...
          <div className="max-w-4xl">
            ...
            <div className="space-y-2 mb-6 md:mb-8 animate-slide-up-delay">
              ...
              <p className="text-sm sm:text-base md:text-lg text-gray-300">
                Serving NJ, NY, PA | 20+ Years Experience
              </p>
            </div>
            ...
            <div className="inline-flex items-center gap-2 bg-primary/20 backdrop-blur-sm border border-primary/30 px-4 py-2 rounded-full animate-fade-in">
              <Award size={16} className="text-primary-light flex-shrink-0" />
              <span className="text-xs sm:text-sm font-medium">Licensed General Contractor - NJ, NY, PA</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mt-4 mb-6">
                20 Years of International Engineering & Construction Excellence
              </h2>
              ...
              <div className="space-y-3 mb-6 md:mb-8">
                {[
                  'Licensed General Contractor serving NJ, NY & PA',
                  'Full-service: Engineering, Architecture & Interior Design',
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto mb-12">
            ...
            <Link
              ...
              className="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-gray-800 to-gray-900 opacity-90 group-hover:opacity-95 transition-opacity"></div>
              <div className="relative p-8 md:p-10 text-white">
                <div className="bg-white/20 backdrop-blur-sm w-16 h-16 rounded-xl flex items-center justify-center mb-6">
                  <HomeIcon size={32} />
                </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <div
                key={index}
                className="group rounded-xl md:rounded-2xl overflow-hidden bg-gray-800 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl"
              >
