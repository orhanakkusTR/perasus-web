...
import { ChevronRight, CheckCircle2, ArrowRight, X, Building2, Users, Award, Clock, Home as HomeIcon, Briefcase, Hammer, Lightbulb } from 'lucide-react';
            ...
            <div className="relative mt-8 lg:mt-0">
              <div className="grid grid-cols-2 gap-3 md:gap-4">
                <div className="space-y-3 md:space-y-4">
                  <img
                    src="/images/MainpagePerasus.jpg"
                  ...
                  />
                  <img
                    src="/images/anasayfaPerrasus.jpg"
                ...
                <div className="space-y-3 md:space-y-4 pt-6 md:pt-8">
                  <img
                    src="/images/HomerenovationPerasus-1.jpg"
                    alt="Interior design"
                    width="600"
                    height="800"
                    className="rounded-xl md:rounded-2xl shadow-xl w-full h-56 sm:h-64 md:h-80 object-cover hover:scale-105 transition-transform duration-500"
            ...
            {[
              {
                ...
                description: 'The right plan for a strong start. Architectural & interior design, on-site analysis, 3D visualization, and material selection — so your project begins on a solid foundation.'
              },
              {
                icon: Building2,
                title: 'Project Build',
                description: 'Turning your approved plan into reality with high-quality craftsmanship, on time and on budget, from large renovations to detailed remodels.'
              },
              {
                icon: Users,
                title: 'Project Management',
                description: 'We manage the entire process — turnkey coordination, scheduling, budget tracking, quality inspections, and permitting — so you enjoy the results stress-free.'
              },
              {
                icon: Lightbulb,
                title: 'Consulting',
            ...
            {[
              {
                ...
                image: '/images/pexels-1307698.jpg',
                category: 'Commercial'
              },
              {
              ...
              },
              {
                ...
                image: '/images/pexels-2724748.jpg',
                category: 'Residential'
              },
              {
                title: 'Bathroom Renovation',
                description: 'Complete bathroom remodeling with waterproofing and modern fixtures',
                image: '/images/pexels-1910472.jpg',
                category: 'Residential'
              },
              {
                title: 'HVAC Systems',
                description: 'Commercial and residential heating, ventilation, and cooling installations',
                image: '/images/pexels-8293778.jpg',
                category: 'Both'
              },
              {
                title: 'Commercial & Office Fit-Outs',
                description: 'Turnkey office renovations, tenant fit-outs, and build-outs for schools, clinics, and institutions',
                image: '/images/CommercialOfficePerasus.jpg',
                category: 'Commercial'
              }
            ].map((service, index) => (
              <div
      ...
      <section className="py-12 md:py-16 bg-gray-50 overflow-hidden">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mb-8">
            {[
              { image: '/images/CommercialOfficePerasus.jpg', title: 'Commercial Office Fit-Out' },
              { image: '/images/RestaurantPerasus.jpg', title: 'Restaurant Renovation' },
              { image: '/images/RoofPerasus.jpg', title: 'Commercial Roofing Project' },
              { image: '/images/MainpagePerasus.jpg', title: 'Commercial Building Renovation' },
              { image: '/images/TransitionKitcehnPerasus.jpg', title: 'Full Kitchen Transformation' },
              { image: '/images/HomerenovationPerasus.jpg', title: 'Complete Home Renovation' }
            ].map((project, index) => (
              <button
                key={index}
