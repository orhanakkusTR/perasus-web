...
export default function Flooring() {
  ...
  const flooringProducts = [
    { name: 'ANSE TIMBERSTONE', image: '/images/anse-timberstone.webp' },
    { name: 'BARLEY ALE', image: '/images/barley-ale.webp' },
    { name: 'BRAZILIAN CHESTNUT WHISKEY BARREL', image: '/images/brazilian-chestnut-whiskey-barrel.webp' },
    { name: 'BRUSHED GREY', image: '/images/brushed-grey.webp' },
    { name: 'CARDAMOM OAK', image: '/images/cardamom-oak.webp' },
    { name: 'CHARCOAL', image: '/images/charcoal.webp' },
    { name: 'INTREPID PEARL WALNUT', image: '/images/intrepid-pearl-walnut.webp' },
    { name: 'LATTE', image: '/images/latte.webp' },
    { name: 'PORTLAND PINE', image: '/images/portland-pine.webp' },
    { name: 'SEAFOAM CEDAR', image: '/images/seafoam-cedar.webp' },
    { name: 'SMOKE', image: '/images/smoke.webp' },
    { name: 'STONE', image: '/images/stone.webp' },
    { name: 'SWANSEA', image: '/images/swansea.webp' },
    { name: 'TAWNY', image: '/images/tawny.webp' },
    { name: 'TOMBSTONE RED OAK', image: '/images/tombstone-red-oak.webp' }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative min-h-[60vh] md:min-h-[70vh] lg:min-h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/images/hero-2-kd.jpg')"
          }}
        ></div>
