import { ArrowRight, Phone, CheckCircle2, Briefcase, Home as HomeIcon, Store, Hotel, Building, School, Palette, PencilRuler, ShieldCheck, Zap, Wind, Droplets, Sparkles } from 'lucide-react';
...
export default function Services() {
  ...
  const commercialServices = [
    ...
    },
    {
      ...
      description: 'Tell us the project you envision — we design, visualize, and build it on-site.',
      features: [
        'Share your vision and requirements',
        'Concept sketches and design proposals',
        '3D visualization before we build',
      ...
      <section className="relative min-h-[60vh] md:min-h-[70vh] flex items-center overflow-hidden pt-32 pb-16 md:pt-40 md:pb-20">
        ...
        <div className="relative z-20 container mx-auto px-6 text-white">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3 mt-8 animate-slide-up-delay-2">
              {['Licensed', 'Insured', 'Bonded'].map((badge) => (
                <span
                  key={badge}
                  className="inline-flex items-center gap-1.5 bg-primary/20 backdrop-blur-sm border border-primary/30 px-3 py-1.5 rounded-full text-xs sm:text-sm font-medium"
                >
                  <ShieldCheck size={14} className="text-primary-light flex-shrink-0" />
                  {badge}
                </span>
              ))}
            </div>
