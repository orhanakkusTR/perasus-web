...
export default function Services() {
  ...
  const commercialServices = [
    ...
    },
    {
      ...
      description: 'Professional bank interior design with security infrastructure',
      features: [
    ...
    {
      icon: Zap,
      title: 'Electrical & Commercial Lighting',
      description: 'Professional electrical infrastructure and lighting installations',
      features: [
  ...
  const residentialServices = [
    {
      ...
      description: 'Professional design services with 3D visualization',
      features: [
  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        description="Comprehensive construction and renovation services in NJ, NY, PA. Commercial: restaurants, hotels, offices. Residential: kitchens, bathrooms, HVAC, outdoor spaces."
