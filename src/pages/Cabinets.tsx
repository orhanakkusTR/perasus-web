...
export default function Cabinets() {
  ...
  const cabinetProducts = [
    { name: 'FUSION BLANC', image: '/images/Fusion_Blanc.webp' },
    { name: 'DISCOVERY FROST', image: '/images/Discovery_Frost.webp' },
    { name: 'FUSION DOVE', image: '/images/Fusion_Dove.webp' },
    { name: 'FUSION KONA', image: '/images/Fusion_Kona.webp' },
    { name: 'FUSION NICKEL', image: '/images/Fusion_Nickel.webp' },
    { name: 'FUSION OYSTER', image: '/images/Fusion_Oyster.webp' },
    { name: 'FUSION STONE', image: '/images/Fusion_Stone.webp' },
    { name: 'GALAXY ESPRESSO', image: '/images/Galaxy-Espresso.webp' },
    { name: 'GALAXY COBBLESTONE', image: '/images/Galaxy_Cobblestone.webp' },
    { name: 'GALAXY FROST', image: '/images/Galaxy_Frost.webp' },
    { name: 'GALAXY INDIGO', image: '/images/Galaxy_Indigo.webp' },
    { name: 'GALAXY NICKEL', image: '/images/galaxy_nickel.webp' },
    { name: 'GALAXY LINEN', image: '/images/GalaxyLinen.webp' },
    { name: 'GLOSS BIANCO', image: '/images/Gloss_Bianco.webp' },
    { name: 'GLOSS GRIGIO', image: '/images/Gloss_Grigio.webp' },
    { name: 'HALLMARK FROST', image: '/images/Hallmark_frost.webp' },
    { name: 'IMPERIO DOVE', image: '/images/Imperio_Dove.webp' },
    { name: 'IMPERIO NICKEL', image: '/images/Imperio_Nickel.webp' },
    { name: 'KITCHEN HORIZON', image: '/images/Kitchen_Horizon.webp' },
    { name: 'LUNA KONA', image: '/images/Luna_-_Kona.webp' },
    { name: 'LUNA DOVE', image: '/images/Luna_Dove.webp' },
    { name: 'LUNA INDIGO', image: '/images/Luna_Indigo.webp' },
    { name: 'LUNA TIMBER', image: '/images/Luna_Timber.webp' },
    { name: 'MATTE BIANCO', image: '/images/Matte_Bianco.webp' },
    { name: 'MATTE CARBONE', image: '/images/Matte_Carbone.webp' },
    { name: 'METRO FROST', image: '/images/Metro-Frost.webp' },
    { name: 'METRO JAVA', image: '/images/Metro_Java.webp' },
    { name: 'METRO MIST', image: '/images/Metro_Mist.webp' },
    { name: 'NEXUS FROST', image: '/images/Nexus_Frost.webp' },
    { name: 'ONYX FROST', image: '/images/onyx_frost.webp' }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative min-h-[60vh] md:min-h-[70vh] lg:min-h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/images/k-3.png')"
          }}
        ></div>
